<template>
  <div class="pricing">
    ...
    <main class="text-center py-6">
      ...
      <p class="text-lg mb-4 glow">Flexible storage with pricing that suits you, cheaper than <b>Dropbox</b> and
        <b>OneDrive.</b></p>
      ...
      <div class="flex justify-center space-x-6">
        ...
        <PricingCard titleClass="purpletext" title="PLUS" price="$2.99" buttonText="Upgrade"
          ...
          features="Use apps to upload files,Total upload cap of 10TB,Upload up to 10 files at a time,Encrypt your files with AES-GCM and share keys via URLs,Choose when links expire,5% off all credit top-ups,Import files from other services"
        ...
        <PricingCard titleClass="orangetext" title="OVERKILL" price="$12.99" buttonText="Contact us"
          ...
          features=">50TB storage cap,Upload up to 50 files at a time,10% off all credit top-ups,Priority support"
          monthly=true>
        </PricingCard>
      </div>
    </main>
